namespace PetraSurpriseMvc.Models
{
    ...
    public partial class PetraSurpriseContext : DbContext
    {
        public PetraSurpriseContext()
            : base("name=PetraSurpriseConn")
        {
        }
        ...
        public virtual DbSet<GiftandGiftFor> GiftandGiftFors { get; set; }
        public virtual DbSet<GiftFor> GiftFors { get; set; }
        public virtual DbSet<GiftOccasion> GiftOccasions { get; set; }
        public virtual DbSet<GiftTheme> GiftThemes { get; set; }
